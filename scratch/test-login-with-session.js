...
async function main() {
  ...
  console.log('Navigating to login WITH existing session...');
  ...
  console.log('Clicking submit with existing session...');
  ...
  if (!redirected) {
    console.log('FAILED TO REDIRECT when session was pre-loaded!');
    await page.screenshot({ path: 'scratch/failed-redirect-with-session.png' });
  }
